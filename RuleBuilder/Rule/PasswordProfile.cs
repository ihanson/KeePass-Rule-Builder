...
namespace RuleBuilder.Rule {
	public class PasswordProfile : IPasswordGenerator {
		...
		private PasswordProfile(PasswordProfile other) : this(other.Profile) {
			this.IsDefaultProfile = other.IsDefaultProfile;
		}
		...
		public PasswordProfile Clone() => new PasswordProfile(this);
	}
}
